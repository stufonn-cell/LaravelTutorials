...
Route::get('/v3/products/paginate', 'App\Http\Controllers\Api\ProductApiControllerV3@paginate')
    ->name('api.v3.product.paginate');

Route::post('/products/store', 'App\Http\Controllers\Api\ProductApiController@store')
